...
const Cart = (props: Props) => {
  ...
  return (
    <div className=" relative min-h-screen flex-col bg-slate-100">
      <Header />

      <div className="mx-auto mt-7  w-[80%]  ">
      ...
      <div className="mx-auto mt-6 ml-0 mr-0  h-[460px] w-[90%] overflow-y-scroll  pl-5">
      ...
      <div className="absolute bottom-0 w-full bg-slate-600 pr-44 pb-12 pt-7 ">
        ...
        <div className="mt-7 flex justify-end text-orange-400">
          <div className=" flex gap-10">
            <p>Tổng tiền phải thanh toán các sản phẩm bạn đã chọn:</p>
